...
class Cenario(ElementoJogo):
    ...
    def pintar_vitoria(self, tela):
        self.pintar_texto_centro(tela, "V O C E  G A N H O U ! ! !")
    ...
    def calcular_regras_pausando(self):
        pass
    ...
    def calcular_regras_jogando(self):
        for movivel in self.moviveis:
            ...
            if isinstance(movivel, Fantasma) and movivel.linha == self.pac.linha and \
...
class Pacman(ElementoJogo, Movivel):
    ...
    def pintar(self, tela):
        ...
        labio_superio = (self.centro_x + self.raio, self.centro_y - self.abertura)
